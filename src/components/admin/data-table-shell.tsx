...
/**
 * Column metadata WITHOUT the render function.
 *
 * `render` is a plain function and cannot cross the Server→Client boundary, so
 * the server wrapper in `data-table.tsx` invokes it and passes the resulting
 * ReactNodes down as `rows[].cells`. React serialises rendered nodes happily;
...
/** One table row, already rendered to nodes by the server wrapper. */
