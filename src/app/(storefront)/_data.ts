...
export { deliveryLabel, SORT_LABELS };
...
// deliveryLabel live in `./_data-shared` — pure, client-safe — and are
// re-exported above so existing imports from `./_data` keep working.)
